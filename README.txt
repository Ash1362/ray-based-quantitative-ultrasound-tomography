...
Note that smaller 'BLITolerance' means inclusion of larger number of grid points, and therefore an increase in the required memory for the k-Wave simulation, but it will make the k-Wave simulations accurate.
