% Example for image reconstruction of the speed from the in-vivo Malignancy
...
% This in-vivo data set is freely available and should be downloaded from
...
% data from the links provided in [5], and add the dataset: 'Malignancy' to
...
% get the experiment number (always fixed for downloading the 'Malignancy' 
% dataset)
experiment_number = 4;
...
if do_greens_approach
    ...
    simulation_prop.alpha_coeff_real(img_tof > 1465) = absorption_coeff_object; % Default = 1.5
