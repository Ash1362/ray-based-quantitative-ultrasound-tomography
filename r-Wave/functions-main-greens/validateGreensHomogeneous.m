...
xlabel('Time [s]');  ylabel('Amplitude [a.u.]'); axis([0 1.2e-5 -1.1 1.1]);
set(gca, 'FontSize', 12);
...
if para.save_plots 
    ...
    saveas(h1, [plot_directory, 'Fig_2a' '.fig' ]);
    saveas(h1, [plot_directory, 'Fig_2a' '.png' ]);
    saveas(h1, [plot_directory, 'Fig_2a' '.tiff' ]);
    saveas(h1, [plot_directory, 'Fig_2a' '.eps' ], 'epsc');
    
    saveas(h2, [plot_directory, 'Fig_2b' '.fig' ]);
    saveas(h2, [plot_directory, 'Fig_2b' '.png' ]);
    saveas(h2, [plot_directory, 'Fig_2b' '.tiff' ]);
    saveas(h2, [plot_directory, 'Fig_2b' '.eps' ], 'epsc');
