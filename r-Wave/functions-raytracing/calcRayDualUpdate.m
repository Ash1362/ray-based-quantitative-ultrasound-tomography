function [pos, interp_coeff_vec, pos_vec] = calcRayDualUpdate(refractive, ray_interp_coeffs,...
...
% Please see Section 3.3.1., Algorithm 1, A Javaherian et al, 2020, 
...
if test_raytracing
   ...
   % end
    ...
    [pos , ds_final] = calcLineIntersect(pos_previous, g, detec_geom);
