function [pos, interp_coeff_vec] = calcRayDualUpdate(refractive, refrcative_gradient_x,...
...
% CALCRAYDUALUPDATE traces a ray using a Dual-Update algorithm, and stores the coefficients
% for the ray-to-grid interpolation. The interpolation is done using a
% Bilinear approach.
%
% DESCRIPTION:
% calRayDualUpdate calculates positions along the ray and their interplation
...
% the ray must be terminated inside the detection volume
