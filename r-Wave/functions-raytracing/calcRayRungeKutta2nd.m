function [pos, interp_coeff_vec] = calcRayRungeKutta2nd(refractive, ray_fields_params,...
...
if test_raytracing
    ...
    [pos , ds_final] = calcIntersectBall(pos_previous, 1/2 * pos_direction, detec_radius);
