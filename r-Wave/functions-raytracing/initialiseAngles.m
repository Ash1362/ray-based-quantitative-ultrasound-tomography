function [polar_directions_initial_guess, res_initial_guess] = ...
    initialiseAngles(solve_ray, polar_direction_receivers, dim, interval_factor,...
    varepsilon, raylinking_method)
%INITIALISEANGLES chooses initial directions closest to the receiver
%
% DESCRIPTION:
% initialiseAngles initialises the ray linking problem simulataneously for all
