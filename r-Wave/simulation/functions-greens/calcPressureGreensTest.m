...
% receivers using the Green's function (the version only for testing purposes) 
%
%   % DESCRIPTION:
...
%       points and receivers are given. This is the version only for
%       testing purposes.
%
%
% USAGE:
    ...
    case 'forward'
        ...
        switch shot_angle
            case 'raylinking'
                ...
                % get the time delays on the receivers
