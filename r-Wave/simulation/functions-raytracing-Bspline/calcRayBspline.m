function [pos, interp_coeff_vec] = calcRayBspline(....
...
%CALCRAYBSPLINE traces a ray using a Mixed-step algorithm, and stores the coefficients
% for the ray-to-grid interpolation. The interpolation is done using a
% Bspline approach.
%
% DESCRIPTION:
% calRayBspline calculates positions along the ray and their interplation
