function [indices, coeff, coeff_derivative_x, coeff_derivative_y, coeff_derivative_z,...
    ...
    coeff_second_derivative_zz] = calcCoeffsIndicesBsplineModified(...
    ...
    paraxial)
%CALCULATECOEFFSINDICESBSPLINE calculates the indices and their corresponding
%interpolation coefficients
%
%
% calcCoeffsIndicesBSpline calculates the the indices of the grid points and their
    ...
    switch dim
        ...
        case 3
            ...
            if paraxial
                ...
                p_dx2y = (vectorise(polynomial_second_derivative_x * polynomial_y'))';
                p_xdy2 = (vectorise(polynomial_x * polynomial_second_derivative_y'))';
                p_dxdy = (vectorise(polynomial_derivative_x * polynomial_derivative_y'))';
