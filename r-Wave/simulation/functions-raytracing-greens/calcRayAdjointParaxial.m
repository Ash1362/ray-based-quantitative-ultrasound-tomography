function [ray_position_adjoint] = calcRayAdjointParaxial(ray_position, ray_spacing, rayspacing_receiver)
%CALCRAYSADJOINTPARAXIAL computes the auxiliary adjoint ray using the
%paraxial approach
%
% DESCRIPTION:
%       calcRaysAdjointParaxial computes the auxiliary adjoint ray suing
...
% get the adjoint ray positions
ray_position_adjoint = [ray_position_x_adjoint; ray_position_y_adjoint];
