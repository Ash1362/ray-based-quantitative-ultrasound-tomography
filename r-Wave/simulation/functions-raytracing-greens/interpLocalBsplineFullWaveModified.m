function [indices, coeff, refractive_target, refractive_gradient_target,...
    ...
    interpLocalBsplineFullWaveModified(pos_point, xvec, yvec, zvec, pos_grid_first,...
...
%       refractive_target - the interpolated refractive index on the
%                           target point
...
[indices, coeff, coeff_derivative_x, coeff_derivative_y, coeff_derivative_z,...
    ...
    calcCoeffsIndicesBsplineModified(pos_point, xvec, yvec, zvec,...
