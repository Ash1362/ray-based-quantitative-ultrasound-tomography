...
switch para.Trans_Geom
    ...
    case 'disk'
        input_args_offGrid  = {'upsampling_rate', para.upsampling_rate, 'UseSpiral', true};
        tr.pos         = tr_pos;
...
[weight, ~, indices_in_union, union_indices] = calculateMask(kgrid, tr, para.Trans_Geom, input_args_offGrid{:});
